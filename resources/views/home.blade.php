                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header bg-green">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username">Показать на</h3>
                            <h5 class="widget-user-desc">карте</h5>
                        </div>
                        <div class="box-footer no-padding">
                            <ul class="nav nav-stacked">
                                <li><a href="#">Получить информацию <span class="pull-right badge bg-green"> Нас. пункт</span></a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- /.widget-user -->
